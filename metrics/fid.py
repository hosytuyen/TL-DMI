...
def get_z(improved_gan, save_dir, loop, i, j):
    if improved_gan==True: #KEDMI
        outputs_z = os.path.join(save_dir, "{}_{}_iter_0_{}_dis.npy".format(loop, i, 2999)) 
        outputs_label = os.path.join(save_dir, "{}_{}_iter_0_{}_label.npy".format(loop, i, 2999)) 
        ...
        outputs_z = os.path.join(save_dir, "{}_{}_iter_{}_{}_z.npy".format(loop, i, j, 2999))
        outputs_label = os.path.join(save_dir, "{}_{}_iter_{}_{}_label.npy".format(loop, i, j, 2999)) 
